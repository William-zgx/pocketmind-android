...
- Release-only gates use machine-readable artifacts for capability matrix
  drift, release record completeness, privacy scanning, privacy notice review,
  APK/AAB scanning, model license review, and physical-device perf baselines; run
  ...
  release record, privacy review, structured model license review, AAB,
  signed-artifact, certificate fingerprint, and release mapping checks.
