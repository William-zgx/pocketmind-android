...
class PocketMindScreenDisplayTest {
    ...
    fun trustBoundaryCopyNamesLocalRemotePermissionAndDeletionControls() {
        ...
        assertTrue(PRODUCT_SETUP_TITLE_TEXT.contains("隐私优先"))
        assertTrue(PRODUCT_SETUP_DESCRIPTION_TEXT.contains("基础问答离线可用"))
        assertTrue(PRODUCT_SETUP_DESCRIPTION_TEXT.contains("远程多模态"))
        assertTrue(PRODUCT_SETUP_DESCRIPTION_TEXT.contains("设备动作"))
        assertTrue(PRODUCT_SETUP_DESCRIPTION_TEXT.contains("确认"))
        ...
        assertTrue(MODEL_MANAGER_POSITIONING_TEXT.contains("本地离线"))
        assertTrue(MODEL_MANAGER_POSITIONING_TEXT.contains("可选远程"))
